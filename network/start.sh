...
docker-compose -f docker-compose.yml up -d ca.org1.example.com ca.org2.example.com ca.org3.example.com orderer.example.com peer0.org1.example.com couchdb1 peer0.org2.example.com couchdb2 peer0.org3.example.com couchdb3 cli
docker ps -a
...
# Update the channel definition to define the anchor peer for Org3 as peer0.org1.example.com
